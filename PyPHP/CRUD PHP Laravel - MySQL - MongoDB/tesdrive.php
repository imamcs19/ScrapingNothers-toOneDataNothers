...
if( isset( $_POST['submit'] ) ){
    ...
    if( $success ){
        echo '<script>alert("File Upload Successfully."); document.location="display.php?page=gdrive";</script>';
    } else { 
...
<center><font size="6">Google Drive API</font></center>
<hr>
<form action="display.php?page=gdrive" method="post" enctype="multipart/form-data">
    <div class="item form-group">
        <label class="col-form-label col-md-3 com-sm-3 label-align">Select your file</label>
